...
class Files(object):
    ...
    def lin_News(self):
        ...
        path2 = path + "闻讯E__" + filetime + "时.xlsx"
        shutil.move(filename, path2)


    def win_News(self):
        desktop_path = os.path.join(os.path.expanduser('~'),"Desktop") #获取桌面路径
        filename = desktop_path + "\\Finance\\News_Economy.xlsx"
    ...
    def win_filename(self):
        ...
        win_file = desktop_path + "\\Finance\\News_Economy.xlsx"
        return win_file
    ...
    def getwinfile(self):
        ...
        path2 = path + "闻讯E__" + filetime + ".xlsx"
        return path2
